...
_ACTIONS: dict[str, tuple[str, str, list[str]]] = {
    ...
    "add_expense": ("finance", "Logged an expense", ["merchant", "amount"]),
    "list_expenses": ("finance", "Checked your spending", ["period", "category"]),
    "expense_summary": ("finance", "Summarised your spending", ["period"]),
